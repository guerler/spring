...
my $topdir= abs_path(dirname(abs_path(__FILE__))."/../../../..");
our $execdir = "$topdir/psipred/bin";  # path to PSIPRED V2 binaries
our $datadir = "$topdir/psipred/data"; # path to PSIPRED V2 data files
our $ncbidir = "$topdir/psiblast/blast/bin";    # path to NCBI binaries (for PSIPRED in addss.pl)
...
our $hhscripts= $hhlib."/lib/hh/scripts"; # path to hh perl scripts (addss.pl, reformat.pl, hhblitsdb.pl etc.)
